...
firefox_binary_path = r'/home/morgen/Desktop/firefox/firefox-bin'  # Provide the path to the Firefox binary
...
def page_test(exp, url):
    ...
    for browser in BROWSERS:
        ...
        try:
            ...
            wait.until(lambda driver: len(driver.execute_script("return isFinished();")) == 1)
